...
// نسخه 3.3.0
$lang['settings_ai']                                      = 'هوش مصنوعی';
$lang['settings_group_ai']                                = 'ادغام هوش مصنوعی';
$lang['settings_ai_general']                              = 'عمومی';
$lang['settings_ai_provider']                             = 'ارائه‌دهنده';
$lang['settings_ai_system_prompt']                        = 'پرامپت سیستمی';
$lang['settings_ai_system_prompt_help']                   = 'برای کمک به هوش مصنوعی در تولید پاسخ‌های بهتر، زمینه مربوط به شرکت خود و نحوه رسیدگی به تیکت‌های پشتیبانی را ارائه دهید.';
$lang['settings_ai_enable_ticket_summarization']          = 'فعال کردن خلاصه‌سازی تیکت';
$lang['settings_ai_enable_ticket_summarization_help']     = 'برای تولید خودکار خلاصه‌ای از مکالمات تیکت، قابلیت خلاصه‌سازی تیکت را فعال کنید.';
$lang['settings_ai_enable_ticket_reply_suggestions']      = 'فعال کردن پیشنهاد پاسخ تیکت';
$lang['settings_ai_enable_ticket_reply_suggestions_help'] = 'برای تولید خودکار پاسخ به مشتری بر اساس مکالمات تیکت، قابلیت پیشنهاد پاسخ تیکت را فعال کنید.';
$lang['ticket_summarization_disabled']                    = 'خلاصه‌سازی تیکت غیرفعال است';
$lang['ticket_reply_suggestion_disabled']                 = 'پیشنهاد پاسخ تیکت غیرفعال است';

$lang['openai_api_key']                 = 'کلید API openai';
$lang['openai_model']                   = 'مدل openai';
$lang['openai']                         = 'openai';
$lang['ticket_summarize_ai']            = 'خلاصه‌سازی (هوش مصنوعی)';
$lang['ticket_suggest_reply']           = 'پیشنهاد پاسخ (هوش مصنوعی)';
$lang['ticket_rephrase_reply']          = 'بازنویسی (هوش مصنوعی)';
$lang['ai_ticket_summary']              = 'خلاصه تیکت (هوش مصنوعی)';
$lang['openai_max_token']               = 'حداکثر توکن خروجی';
$lang['warn_ticket_thread_too_long']    = 'این تیکت حاوی حجم زیادی اطلاعات است. پردازش چنین تیکت طولانی ممکن است به توکن‌های ورودی بیشتری نیاز داشته باشد که می‌تواند بر دقت یا کارایی پاسخ تأثیر بگذارد. آیا می‌خواهید این درخواست را ادامه دهید؟';
$lang['text_enhancement_make_friendly'] = 'دوستانه‌تر کن';
$lang['text_enhancement_make_formal']   = 'رسمی‌تر کن';
$lang['text_enhancement_make_polite']   = 'مؤدبانه‌تر کن';

$lang['openai_fine_tuning']                 = 'تنظیم دقیق openai';
$lang['fine_tuning_source_data']            = 'داده منبع برای تنظیم دقیق';
$lang['available_articles']                 = 'مقالات موجود';
$lang['fine_tuning_min_articles']           = 'برای تنظیم دقیق حداقل به ۱۰ مقاله دانش پایه نیاز دارید.';
$lang['start_fine_tuning']                  = 'شروع تنظیم دقیق';
$lang['last_fine_tuning_job']               = 'آخرین وظیفه تنظیم دقیق';
$lang['job_id']                             = 'شناسه وظیفه';
$lang['status']                             = 'وضعیت';
$lang['fine_tuned_model']                   = 'مدل تنظیم دقیق شده';
$lang['created_at']                         = 'ایجاد شده در';
$lang['finished_at']                        = 'پایان یافته در';
$lang['loading_job_status']                 = 'در حال بارگیری وضعیت وظیفه...';
$lang['refresh_status']                     = 'بازخوانی وضعیت';
$lang['fine_tuned_models']                  = 'مدل‌های تنظیم دقیق شده';
$lang['enable_fine_tuning']                 = 'فعال کردن تنظیم دقیق';
$lang['no_fine_tuned_models']               = 'هنوز مدل تنظیم دقیق شده‌ای در دسترس نیست.';
$lang['model_id']                           = 'شناسه مدل';
$lang['owned_by']                           = 'متعلق به';
$lang['options']                            = 'گزینه‌ها';
$lang['active']                             = 'فعال';
$lang['set_as_active']                      = 'تنظیم به عنوان فعال';
$lang['processing']                         = 'در حال پردازش...';
$lang['error_processing_request']           = 'خطا در پردازش درخواست';
$lang['fine_tuning_completed']              = 'تنظیم دقیق با موفقیت انجام شد!';
$lang['fine_tuning_enabled']                = 'تنظیم دقیق فعال شده است';
$lang['fine_tuning_disabled']               = 'تنظیم دقیق غیرفعال شده است';
$lang['fine_tuned_model_set']               = 'مدل تنظیم دقیق شده به عنوان فعال تنظیم شد';
$lang['confirm_delete_fine_tuned_model']    = 'آیا از حذف این مدل تنظیم دقیق شده اطمینان دارید؟ این عمل قابل بازگشت نیست.';
$lang['fine_tuned_model_deleted']           = 'مدل تنظیم دقیق شده حذف شد';
$lang['fine_tuned_model_delete_failed']     = 'حذف مدل تنظیم دقیق شده با شکست مواجه شد';
$lang['fine_tuning_base_model']             = 'مدل پایه تنظیم دقیق';
$lang['fine_tuning_base_model_description'] = 'این مدل پایه‌ای است که برای تنظیم دقیق استفاده می‌شود. مدل‌های مختلف دارای قابلیت‌ها و قیمت‌های متفاوتی هستند.';
$lang['advanced_features']                  = 'ویژگی‌های پیشرفته';
$lang['openai_fine_tuning_description']     = 'مدل‌های اوپن‌ایآی را با محتوای دانش پایه و پاسخ‌های از پیش تعریف شده خود برای پاسخ‌های دقیق‌تر، تنظیم دقیق کنید.';
$lang['retrain_model']                      = 'بازآموزی مدل';
$lang['retrain_model_description']          = 'یک مدل تنظیم دقیق شده جدید با آخرین محتوا ایجاد کنید. مدل‌های تنظیم دقیق شده قبلی حذف خواهند شد.';
$lang['model_is_recommended']               = 'توصیه می‌شود';

// 3.4.0
$lang['settings_group_einvoice']                                = 'صورتحساب الکترونیکی';
$lang['settings_einvoice_templates']                            = 'قالب‌های صورتحساب الکترونیکی';
$lang['einvoice']                                               = 'صورتحساب الکترونیکی';
$lang['settings_einvoice_default_template']                     = 'قالب پیش‌فرض صورتحساب الکترونیکی';
$lang['settings_einvoice_default_credit_note_template']         = 'قالب پیش‌فرض صورتحساب الکترونیکی برای یادداشت اعتباری';
$lang['settings_einvoice_send_as_invoice_email_attachment']     = 'ارسال صورتحساب الکترونیکی به عنوان پیوست فاکتور در ایمیل';
$lang['settings_einvoice_send_as_credit_note_email_attachment'] = 'ارسال صورتحساب الکترونیکی به عنوان پیوست یادداشت اعتباری در ایمیل';
$lang['einvoice_new_template']                                  = 'قالب جدید صورتحساب الکترونیکی';
$lang['einvoice_template_invalid_xml']                          = 'محتوای XML وارد شده نامعتبر است. لطفاً اصلاح کنید';
$lang['einvoice_template_invalid_xml_on_submit']                = 'XML نامعتبر است. لطفاً قبل از ارسال، خطاها را اصلاح کنید.';
$lang['einvoice_template_invalid_json']                         = 'محتوای JSON وارد شده نامعتبر است. لطفاً نحو JSON را اصلاح کنید.';
$lang['einvoice_template_invalid_mustache']                     = 'قالب شامل نحو نامعتبر Mustache است. لطفاً متغیرهای قالب خود را بررسی کنید.';
$lang['xml_error']                                              = 'خطای XML';
$lang['einvoice_no_template_set']                               = 'هیچ قالبی برای صورتحساب الکترونیکی تنظیم نشده است. لطفاً یکی را در تنظیمات انتخاب کنید.';
$lang['einvoice_module_permission_bulk']                        = 'خروجی انبوه';
$lang['einvoice_module_bulk_export']                            = 'خروجی صورتحساب الکترونیکی';
$lang['template_type']                                          = 'نوع';
$lang['template_variables']                                     = 'متغیرهای قالب';
$lang['validate_template']                                      = 'اعتبارسنجی قالب';
$lang['validating']                                             = 'در حال اعتبارسنجی...';
$lang['saving']                                                 = 'در حال ذخیره‌سازی...';
$lang['template_validation_success']                            = 'اعتبارسنجی قالب موفقیت‌آمیز بود!';
$lang['template_content_required']                              = 'محتوای قالب الزامی است.';

$lang['item_is_optional']  = 'این آیتم اختیاری است';
$lang['item_is_selected']  = 'انتخاب شده';
$lang['note_title']        = 'عنوان یادداشت';
$lang['note_content']      = 'محتوای یادداشت';
$lang['enabled_languages'] = 'زبان‌های فعال';

$lang['csv_export']               = 'خروجی CSV';
$lang['csv_exports']              = 'خروجی‌های CSV';
$lang['contacts']                 = 'مخاطبین';
$lang['csv_export_select_type']   = 'نوع خروجی';
$lang['csv_export_all_time']      = 'کل زمان';
$lang['csv_export_three_months']  = '۳ ماه گذشته';
$lang['csv_export_six_months']    = '۶ ماه گذشته';
$lang['csv_export_twelve_months'] = '۱۲ ماه گذشته';
$lang['csv_export_from_date']     = 'از تاریخ';
$lang['csv_export_to_date']       = 'تا تاریخ';
$lang['csv_export_button']        = 'خروجی';

# 3.4.1
$lang['clear_queue'] = 'پاک کردن صف';
$lang['email_queue_cleared'] = 'صف ایمیل با موفقیت پاک شد';
$lang['proposal_auto_convert_leads_to_client_on_client_accept'] = 'هنگام پذیرش پیشنهاد توسط مشتری، سرنخ‌ها به طور خودکار به مشتری تبدیل شوند';
