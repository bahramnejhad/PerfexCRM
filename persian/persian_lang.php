...
$lang['settings_group_ai']                                = 'یکپارچه‌سازی هوش مصنوعی';
$lang['settings_ai_general']                              = 'عمومی';
$lang['settings_ai_provider']                             = 'ارائه‌دهنده';
$lang['settings_ai_system_prompt']                        = 'دستورالعمل سیستم';
$lang['settings_ai_system_prompt_help']                   = 'اطلاعاتی درباره شرکت و نحوه مدیریت تیکت‌های پشتیبانی خود وارد کنید تا هوش مصنوعی پاسخ‌های بهتر و دقیق‌تری تولید کند.';
$lang['settings_ai_enable_ticket_summarization']          = 'فعال‌سازی خلاصه‌سازی تیکت';
$lang['settings_ai_enable_ticket_summarization_help']     = 'قابلیت خلاصه‌سازی خودکار مکالمات تیکت‌ها توسط هوش مصنوعی را فعال کنید.';
$lang['settings_ai_enable_ticket_reply_suggestions']      = 'فعال‌سازی پیشنهاد پاسخ تیکت';
$lang['settings_ai_enable_ticket_reply_suggestions_help'] = 'قابلیت تولید پاسخ پیشنهادی برای مشتری بر اساس محتوای مکالمه تیکت توسط هوش مصنوعی را فعال کنید.';
...
$lang['ticket_rephrase_reply']          = 'بازنویسی پاسخ (هوش مصنوعی)';
$lang['ai_ticket_summary']              = 'خلاصه تیکت (هوش مصنوعی)';
$lang['openai_max_token']               = 'حداکثر توکن خروجی';
$lang['warn_ticket_thread_too_long']    = 'این تیکت شامل اطلاعات زیادی است. پردازش یک تیکت طولانی ممکن است به توکن ورودی بیشتری نیاز داشته باشد و روی دقت یا سرعت پاسخ تأثیر بگذارد. آیا می‌خواهید ادامه دهید؟';
$lang['text_enhancement_make_friendly'] = 'صمیمی‌تر کردن';
$lang['text_enhancement_make_formal']   = 'رسمی‌تر کردن';
$lang['text_enhancement_make_polite']   = 'مودبانه‌تر کردن';

$lang['openai_fine_tuning']                 = 'فاین‌تیونینگ OpenAI';
$lang['fine_tuning_source_data']            = 'داده‌های منبع برای فاین‌تیونینگ';
$lang['available_articles']                 = 'مقالات موجود';
$lang['fine_tuning_min_articles']           = 'برای فاین‌تیونینگ حداقل به ۱۰ مقاله دانشنامه نیاز دارید.';
$lang['start_fine_tuning']                  = 'شروع فاین‌تیونینگ';
$lang['last_fine_tuning_job']               = 'آخرین عملیات فاین‌تیونینگ';
$lang['job_id']                             = 'شناسه عملیات';
$lang['status']                             = 'وضعیت';
$lang['fine_tuned_model']                   = 'مدل فاین‌تیون‌شده';
$lang['created_at']                         = 'تاریخ ایجاد';
$lang['finished_at']                        = 'تاریخ پایان';
$lang['loading_job_status']                 = 'در حال دریافت وضعیت عملیات...';
$lang['refresh_status']                     = 'بروزرسانی وضعیت';
$lang['fine_tuned_models']                  = 'مدل‌های فاین‌تیون‌شده';
$lang['enable_fine_tuning']                 = 'فعال‌سازی فاین‌تیونینگ';
$lang['no_fine_tuned_models']               = 'هنوز هیچ مدل فاین‌تیون‌شده‌ای وجود ندارد.';
$lang['model_id']                           = 'شناسه مدل';
$lang['owned_by']                           = 'مالک';
$lang['options']                            = 'گزینه‌ها';
$lang['active']                             = 'فعال';
$lang['set_as_active']                      = 'فعال‌سازی';
$lang['processing']                         = 'در حال پردازش...';
$lang['error_processing_request']           = 'خطا در پردازش درخواست';
$lang['fine_tuning_completed']              = 'فاین‌تیونینگ با موفقیت انجام شد!';
$lang['fine_tuning_enabled']                = 'فاین‌تیونینگ فعال شد';
$lang['fine_tuning_disabled']               = 'فاین‌تیونینگ غیرفعال شد';
$lang['fine_tuned_model_set']               = 'مدل فاین‌تیون‌شده به‌عنوان مدل فعال انتخاب شد';
$lang['confirm_delete_fine_tuned_model']    = 'آیا مطمئن هستید که می‌خواهید این مدل فاین‌تیون‌شده را حذف کنید؟ این عملیات قابل بازگشت نیست.';
$lang['fine_tuned_model_deleted']           = 'مدل فاین‌تیون‌شده حذف شد';
$lang['fine_tuned_model_delete_failed']     = 'حذف مدل فاین‌تیون‌شده ناموفق بود';
$lang['fine_tuning_base_model']             = 'مدل پایه برای فاین‌تیونینگ';
$lang['fine_tuning_base_model_description'] = 'این مدل پایه‌ای است که برای فاین‌تیونینگ استفاده می‌شود. مدل‌های مختلف قابلیت‌ها و هزینه‌های متفاوتی دارند.';
$lang['advanced_features']                  = 'ویژگی‌های پیشرفته';
$lang['openai_fine_tuning_description']     = 'مدل‌های OpenAI را با دانش موجود و پاسخ‌های از پیش تعریف‌شده فاین‌تیون کنید تا پاسخ‌های دقیق‌تری ایجاد شوند.';
$lang['retrain_model']                      = 'فاین‌تیون مجدد مدل';
$lang['retrain_model_description']          = 'یک مدل جدید با محتوای به‌روز ایجاد کنید. مدل‌های فاین‌تیون‌شده قبلی حذف خواهند شد.';
$lang['model_is_recommended']               = 'پیشنهاد شده';
...
$lang['settings_einvoice_default_credit_note_template']         = 'قالب پیش‌فرض صورتحساب الکترونیکی برای یادداشت بستانکاری';
$lang['settings_einvoice_send_as_invoice_email_attachment']     = 'ارسال صورتحساب الکترونیکی به‌عنوان پیوست ایمیل صورتحساب';
$lang['settings_einvoice_send_as_credit_note_email_attachment'] = 'ارسال صورتحساب الکترونیکی به‌عنوان پیوست ایمیل یادداشت بستانکاری';
$lang['einvoice_new_template']                                  = 'قالب جدید صورتحساب الکترونیکی';
$lang['einvoice_template_invalid_xml']                          = 'محتوای XML واردشده نامعتبر است. لطفاً آن را اصلاح کنید.';
$lang['einvoice_template_invalid_xml_on_submit']                = 'XML نامعتبر است. لطفاً خطاها را قبل از ارسال اصلاح کنید.';
$lang['einvoice_template_invalid_json']                         = 'محتوای JSON واردشده نامعتبر است. لطفاً ساختار JSON را بررسی کنید.';
$lang['einvoice_template_invalid_mustache']                     = 'قالب شامل ساختار نامعتبر Mustache است. لطفاً متغیرهای قالب را بررسی کنید.';
$lang['xml_error']                                              = 'خطای XML';
$lang['einvoice_no_template_set']                               = 'هیچ قالب صورتحساب الکترونیکی تنظیم نشده است. لطفاً از تنظیمات یک قالب انتخاب کنید.';
$lang['einvoice_module_permission_bulk']                        = 'خروجی گروهی';
...
$lang['template_validation_success']                            = 'اعتبارسنجی قالب با موفقیت انجام شد!';
$lang['template_content_required']                              = 'محتوای قالب الزامی است.';

$lang['item_is_optional']  = 'این مورد اختیاری است';
...
$lang['csv_export_all_time']      = 'تمام زمان‌ها';
$lang['csv_export_three_months']  = '۳ ماه اخیر';
$lang['csv_export_six_months']    = '۶ ماه اخیر';
$lang['csv_export_twelve_months'] = '۱۲ ماه اخیر';
...
$lang['proposal_auto_convert_leads_to_client_on_client_accept'] = 'تبدیل خودکار سرنخ‌ها به مشتری هنگام پذیرش پیشنهاد';
